...
console.log('Vamos começar')
 //Usando o FOR você tem o mesmo resultado e uma lógica parecida com o exemplo acima.
 for (var cont = 1; cont <= 5; cont++) {
//O FOR terá três partes.
//INICIALIZAÇÃO ; CONDIÇÃO ; INCREMENTE

//Inicialização: tudo que precisará ser criado para ser usado na condição.
